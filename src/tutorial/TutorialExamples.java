...
public class TutorialExamples {
    ...
    public static void example20() throws Exception {
        ...
        conn.add(amsterdam, location, vf.createLiteral("+52.366665+004.883333",sphericalSystemKM));
        conn.add(london, location, vf.createLiteral("+51.533333-000.08333333",sphericalSystemKM));
        conn.add(sanfrancisco, location, vf.createLiteral("+37.783333-122.433334",sphericalSystemKM));
        conn.add(salvador, location, vf.createLiteral("-13.783333-038.45",sphericalSystemKM));
        println("Locate entities within box2.");
		printRows( conn.getStatementsInBox(sphericalSystemKM, location, 0.08f, 0.09f, 51.0f, 52.0f, 0, false) );
		println("Locate entities within haversine circle.");
		printRows(conn.getGeoHaversine(sphericalSystemKM, location, 50.0f, 0.0f, 1000.0f, "km", 0, false) );
