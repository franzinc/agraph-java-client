 ...
 * 
 * org.openrdf.query.parser.sparql.SPARQLUpdateTest
 * 
 * that allows access to rep, con, f, etc in subclasses.
 * 
 */
public abstract class SPARQLUpdateTest {
		...
		throws Exception
	{
		...
		/* TODO: make this debug info, or add tests?
	...
	/**
	 * TODO: This test uses blank node syntax in a delete,
	 * which seems to violate the sparql grammar (see note 9.):
	 * 
	...
	/**
	 * TODO: This test assumes support for empty named graphs?
	 * 
	 * http://www.w3.org/TR/sparql11-update/#create
	 * 
	 * "Stores that do not record empty named graphs will always 
	 * return success on creation of a non-existing graph."
	 *
	@Test
