...
public class Closer implements Closeable {
	...
	Obj Close(Obj o) {
		if (o instanceof Closeable) {
			return (Obj) Util.close((Closeable)o);
		} else if (o instanceof java.io.Closeable) {
			return (Obj) Util.close((java.io.Closeable)o);
		} else if (o instanceof CloseableIteration) {
			return (Obj) Util.close((CloseableIteration)o);
		} else if (o instanceof XMLStreamReader) {
			return (Obj) Util.close((XMLStreamReader)o);
		} else if (o instanceof MultiThreadedHttpConnectionManager) {
			return (Obj) Util.close((MultiThreadedHttpConnectionManager)o);
		} else if (o != null) {
			try {
