...
public abstract class RepositoryConnectionTest extends TestCase {
		...
		throws Exception
	{
		...
		strangeUnicodeVarname = vf.createLiteral("strangeUnicodeVarname");
	...
	@Ignore public void testTransactionIsolation()
		throws Exception
	{
		...
		throws Exception
	{
		...
		queryBuilder.append(" FROM {person} foaf:name {").append(strangeUnicodeVarname.getLabel()).append("}");
		queryBuilder.append(" USING NAMESPACE foaf = <" + FOAF_NS + ">");
		...
		throws Exception
	{
		...
		//mm: It looks like Sesame expects the parsing of the RDF to leave
		// persistent namespace definitions in the store???
